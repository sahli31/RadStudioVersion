...
type
  ...
  private
    ...
    procedure LoadRadVersion(FromGit:Boolean=False);
...
procedure TFrmMain.LoadRadVersion(FromGit:Boolean=False);
begin
  ComboBox1.Clear;
  LoadRadStudioVersion(RadStudioVersionList,FromGit);
...
begin
  ...
  HowToUse:=HowToUse + 'https://github.com/elseif/RadStudioVersion' + sLineBreak;
